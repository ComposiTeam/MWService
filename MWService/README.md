MWService: Kitchensink Example using Spring 4.x
==============================================================
Author: Marius Bogoevici, Tejas Mehta, Joshua Wilson  
Level: Intermediate  
Technologies: JSP, JPA, JSON, Spring, JUnit  
Summary: The `MWService` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x.  
Target Product: WFK  
...
The `MWService` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x. It 
...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="br.com.compositeam.controller"/>` 
...
4. This will deploy `target/MWService.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/MWService/>.
